...
const Livebid = ({selectedId, auction, handleClose, data}) => {
  ...
  return (
    ...
    className="md:px-16 z-[400] bg-white h-full w-full fixed top-0 left-0 px-4 my-4">  
      <motion.div className="flex border  mt-10 border-black">
        <div className="w-full md:w-1/2 relative">
          ...
          <div className="absolute top-4 flex justify-between items-center px-8 w-full">
            <div onClick={handleClose} className="w-10 cursor-pointer h-10 bg-gray-400 flex rounded-full justify-center items-center">
              X
            </div>
